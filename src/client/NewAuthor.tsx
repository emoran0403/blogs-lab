      ...
      <div className="d-flex justify-content-center mt-5">
        <div className="card bg-light shadow col-md-4">
          <div className="card-body d-flex flex-wrap justify-content-center">
            ...
            <input placeholder="Author Name (username)" type="text" value={props.username} className="form-control col-md-7 mb-1" onChange={(e) => props.handleUsernameChange(e)} />
            <input placeholder="Email" type="email" value={props.email} className="form-control col-md-7 my-1" onChange={(e) => props.handleEmailChange(e)} />
            <textarea
