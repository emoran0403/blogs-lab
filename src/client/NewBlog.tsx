      ...
      <div className="d-flex justify-content-center mt-5">
        <div className="card bg-light shadow col-md-4">
          <div className="card-body d-flex flex-wrap justify-content-center">
            ...
            <textarea placeholder="Your content here" value={props.content} className="form-control col-md-7 my-1" onChange={(e) => props.handleContentChange(e)}></textarea>

            <select onChange={(e) => props.setSelectedTagId(Number(e.target.value))} className="form-select my-1" value={Number(props.selectedTagId)}>
