...
const NewAuthor = () => {
    const [authorname, setAuthorname] = useState<string>("atlc");
    const [email, setEmail] = useState<string>("test@test.com");
    const [authorbio, setAuthorBio] = useState<string>("asdukhwqeui23kh2ihiuh123");
            ...
            <div className="d-flex justify-content-center mt-5">
                <div className="card bg-light shadow col-md-4">
                    <div className="card-body d-flex flex-wrap justify-content-center">
                        ...
                        <input placeholder="Author Name (username)" type="text" value={authorname} className="form-control col-md-7 mb-1" onChange={e => setAuthorname(e.target.value)} />

                        <input placeholder="Email" type="email" value={email} className="form-control col-md-7 my-1" onChange={e => setEmail(e.target.value)} />

                        <input placeholder="Password" type="password" value={password} className="form-control col-md-7 my-1" onChange={e => setPassword(e.target.value)} />

                        <textarea placeholder="Tell us about yourself." value={authorbio} className="form-control col-md-7 mt-1" onChange={e => setAuthorBio(e.target.value)}></textarea>
