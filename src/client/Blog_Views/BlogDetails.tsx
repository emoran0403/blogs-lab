...
const BlogDetails = () => {
    ...
    const [BLOG, setBLOG] = useState<Types.Blog>(null);
    ...
    const getSingleBlog = () => {
        ...
        Fetcher.GET(`/api/blogs/${id}`)
            .then(data => {
                setBLOG(data);
                console.log({ data });
            })
            .catch(error => {
                console.log(`Get Single Blog Error.  Blog ID: ${id}...\n`);
                console.error({ error });
            });
    };
    ...
    const contentToShowWhenNotEditing = () => {
        return (
            <>
            ...
            <div className="d-flex flex-wrap justify-content-around">
                <div className="card col-md-6 mx-2">
                    <div className="card-body">
                        ...
                        {!isEditing && contentToShowWhenNotEditing()}

                        {/* Show this when Editing ************************************************/}
                        {isEditing && contentToShowInEditMode()}
                    </div>
                </div>
            </div>
        </>
